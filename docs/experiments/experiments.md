...
$$f_{bare}(t) + f_{veg}(t) + f_{other}(t) = 1$$
...
* **LMIP (Land Surface, Snow and Soil Moisture MIP):** We collaborate closely with LMIP to ensure that dynamic boundary modifications are physically consistent with land-surface hydrology and soil thermodynamics.
