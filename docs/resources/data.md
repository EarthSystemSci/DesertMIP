...
* **Primary Node:** Earth System Grid Federation (ESGF) input data directory.
* **Secondary Mirror:** Zenodo repository (assigned with a permanent DOI for proper academic citation and persistent access).
...
For access to the code base and detailed technical documentation, please visit the DesertMIP GitHub Repository.
